...
const SpiritualExhibitionPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>Spiritual Exhibition - Satlok Ashram</title>
      ...
      <main>
        ...
        <div className="relative h-[60vh] min-h-[500px]">
          <Image
            src="/images/spiritual-exhibition.webp"
            alt="Spiritual Exhibition"
            fill
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/50">
            <div className="container mx-auto px-4 h-full flex items-center">
              <div className="max-w-2xl text-white">
                <h1 className="text-4xl md:text-5xl font-bold mb-4">Spiritual Exhibition</h1>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Virtual Tour</h2>
                <p className="text-gray-600 mb-8">
                  Experience our spiritual exhibition from anywhere in the world through our immersive virtual tour.
                </p>
                <button className="bg-red-600 text-white px-8 py-3 rounded-lg hover:bg-red-700 transition-colors">
                  Start Virtual Tour
                </button>
...
export default SpiritualExhibitionPage;
